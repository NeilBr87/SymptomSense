    ...
    return (
        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
            ...
            <div style={{marginTop: '-2%'}}>
                ...
                <h2 style={{marginTop: '3%', fontSize: isMobile? '18px' : '25px', margin: '0 auto', width: isMobile? '360px' : '1200px'}}>A tracker app for you to monitor new symptoms and present accurate occurrence data to your GP.</h2>
                ...
                <div style={{display: 'flex', flexDirection: isMobile? 'column' : 'row', justifyContent: 'center', alignItems: 'center', gap: isMobile? '0%' : '5%'}}>
                    <div>
                        ...
                        <p style={{fontSize: isMobile? '12px' : '18px', width: isMobile? '340px' : '660px', marginTop: '3%', textAlign: isMobile? 'center' : 'justify'}}>SymptomSense is a free app built by Neil Brooks, an independent developer. It is not assocated with the NHS or any medical body.</p>
                    </div>
                ...
                <div style={{width: isMobile ? '240px' : '1200px', marginTop: '3%', margin: '0 auto', backgroundColor: '#F2AF29', padding: '5px', borderRadius: '20px', marginBottom: '20px'}}>
                <h3 style={{fontSize: isMobile? '12px' : '18px'}}>Important disclaimer</h3>
                    ...
                    <p style={{fontSize: isMobile? '10px' : '16px'}}>This app is NOT designed to hold identifiable personal data. I recommend that you signup to the app using a temporary email address that cannot be traced back to you. Any deviation from this advice will be entirely at the user's risk.</p>
                </div>
            </div>}
